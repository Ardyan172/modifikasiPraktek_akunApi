...
<html lang="en">
<head>
  <title>@yield('title', 'belum diberikan')</title>
  <!-- yield menerima nilai default sebagai parameter kedua -->
  <!-- Required meta tags -->
  <meta charset="utf-8">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="" target="_blank">Ardyan</a> untuk sebuah web yang lebih baik
          </div>
          <!-- your footer here -->
        </div>
      </footer>
