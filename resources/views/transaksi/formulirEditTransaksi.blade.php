        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="/transaksi/update/{{ $detailTransaksi->id }}" method="POST" enctype="multipart/form-data">
                <!-- arahkan ke url transaksi, TransaksiController lalu method store -->
                @csrf
                <div class="form-group">
                  <label for="namaTransaksi">Nama Transaksi</label>
                  <input type="text" name="namaTransaksi" class="@error('namaTransaksi') is-invalid @enderror form-control" id="namaTransaksi" placeholder="Laptop" value="{{ $detailTransaksi->namaTransaksi }}">
                  @error('namaTransaksi')
                ...
                <div class="form-group">
                  ...
                  value="{{ $detailTransaksi->tipeTransaksi }}">
                ...
                <div class="form-group">
                  ...
                  value="{{ $detailTransaksi->jumlahTransaksi }}">
                ...
                <div class="@error('fotoTransaksi') is-invalid @enderror fileinput fileinput-new text-center" data-provides="fileinput">
                    <div class="fileinput-new thumbnail img-raised">
                        <img src="{{ asset('foto_transaksi') }}/{{ $detailTransaksi->fotoTransaksi }}" rel="nofollow" alt="Foto Transaksi">
                    </div>
